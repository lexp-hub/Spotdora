    ...
    pub fn new_from_gsettings() -> Option<Self> {
        ...
        let backend = match settings.enum_("audio-backend") {
            ...
            2 => Some(AudioBackend::GStreamer(
                "audioconvert dithering=none ! audioresample ! pipewiresink client-name=Spotdora stream-properties=\"props,media.role=music\"".to_string(), // PipeWire pipeline for Fedora
            )),
            _ => None,
        }?;
